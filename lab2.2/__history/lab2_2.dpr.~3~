...
Begin
    Writeln('Данная программа находит самое маленькое натуральное число, для которого верно следующее условие: ',#10,'Eсли последнюю цифру этого числа перенести и поставить перед первой цифрой, то получится число, в два раза больше исходного числа.');
End;
